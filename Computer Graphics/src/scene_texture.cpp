...
cgmath::mat4 scene_texture::modelMatrix()
{
	float PI = 3.14159f;
...
cgmath::mat4 scene_texture::viewMatrix()
{
...
cgmath::mat4 scene_texture::perspectiveMatrix(float width, float height)
{
	float PI = 3.14159f;
...
void scene_texture::initializeVector() {
